...
# ACDS 18.1 625 win32 2023.07.12.16:04:10
# ----------------------------------------
...
# ----------------------------------------
# If div_three_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "div_three_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/div_three_pll.vo"
}
